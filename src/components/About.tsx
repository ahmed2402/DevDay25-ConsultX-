    ...
    <section id="about" className="bg-white py-24">
      <div className="section-container">
        ...
        <p className="section-subtitle text-center mx-auto">
          I'm a strategic business consultant with over 15 years of experience helping organizations achieve sustainable growth.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mt-16">
          ...
          <div className="md:col-span-7 ">
            ...
            <p className="text-consultant-darkGray mb-8">
              Having worked with organizations across various industries including technology, finance, healthcare, and retail, I bring a wealth of cross-sector insights that enable innovative problem-solving and effective strategy development.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-10">
              {achievements.map((item, index) => (
                <div key={index} className="consultant-card p-6 hover-lift">
                  ...
                  <h4 className="text-lg font-bold text-consultant-navy mb-2">{item.title}</h4>
                  <p className="text-consultant-darkGray text-sm">{item.description}</p>
                </div>
              ))}
            </div>
            
            <div className="mt-10 pt-10 border-t border-consultant-lightGray">
              <h4 className="text-xl font-bold text-consultant-navy mb-4">Areas of Expertise</h4>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="flex items-center">
                  <div className="w-2 h-2 rounded-full bg-consultant-blue mr-2"></div>
                  <span className="text-consultant-darkGray">Strategic Planning</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 rounded-full bg-consultant-blue mr-2"></div>
                  <span className="text-consultant-darkGray">Operational Optimization</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 rounded-full bg-consultant-blue mr-2"></div>
                  <span className="text-consultant-darkGray">Growth Strategy</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 rounded-full bg-consultant-blue mr-2"></div>
                  <span className="text-consultant-darkGray">Digital Transformation</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 rounded-full bg-consultant-blue mr-2"></div>
                  <span className="text-consultant-darkGray">Market Entry Analysis</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 rounded-full bg-consultant-blue mr-2"></div>
                  <span className="text-consultant-darkGray">Business Model Innovation</span>
                </div>
              </div>
            </div>
          </div>
